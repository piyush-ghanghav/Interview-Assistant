    ...
    <section className="bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 min-h-screen">
      <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
        ...
        <section className="relative flex h-32 items-end lg:col-span-5 lg:h-full xl:col-span-6 overflow-hidden">
          ...
          {/* Content */}
          <div className="hidden lg:relative lg:block lg:p-12 z-50 w-full">
            {/* Logo */}
            <a className="block text-white transform hover:scale-105 transition-transform duration-300" href="#">
              <span className="sr-only">Home</span>
              <div className="flex items-center gap-3">
                <svg
                  className="h-5 sm:h-5 drop-shadow-2xl"
                  viewBox="0 0 28 24"
                  fill="none"
                ...
                <span className="text-xl font-bold">InterviewPro AI</span>
              </div>
            </a>
            ...
            <div className="mt-16 space-y-6">
              ...
              <p className="text-lg leading-relaxed text-white/90 max-w-md">
                Your AI-powered interview preparation platform. Master your interviews with intelligent mock sessions and real-time feedback.
              </p>
              ...
              <div className="flex flex-wrap gap-3 pt-4">
                ...
                <div className="px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full border border-white/20">
                  <span className="text-white text-sm">📈 Track Progress</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <main className="flex items-center justify-center px-8 py-8 sm:px-12 lg:col-span-7 lg:px-16 lg:py-12 xl:col-span-6 relative">
            {/* Clerk Sign Up Component with Enhanced Container */}
              <SignUp />
        </main>
      </div>
    </section>
